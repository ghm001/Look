package com.look.utils.jsonUtilforSService;
 ...
 */
public class JsonUtilforService {
    ...
    json--map
     */
    public  static <T> Map<String,T>jsonToMap(String jsonStr,Class<T> t) {
