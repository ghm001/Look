...
/**
 * Created by gaohongming on 2017/6/3.
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = "classpath:applicationContext-test.xml")
public class JudgeLabelContralTest {
    @Resource
    ...
    public void judgeUserUpInageLabelInfo() throws Exception {
      ...
      String appGroupInfoJson="{\n" +
              ...
              "    \"imageId6\": 42,\n" +
              "    \"imageNum\": 6,\n" +
              "    \"imageUrl1\": \"https://obs.myhwclouds.com/look.admin.image/华为/2017-5-20/手机-桌子.jpg\",\n" +
              "    \"imageUrl2\": \"https://obs.myhwclouds.com/look.admin.image/华为/2017-5-20/笔记本电脑-桌子-鼠标-手机.jpg\",\n" +
              "    \"imageUrl3\": \"https://obs.myhwclouds.com/look.admin.image/华为/2017-5-20/笔记本电脑-椅子-眼睛-桌子.jpg\",\n" +
              "    \"imageUrl4\": \"https://obs.myhwclouds.com/look.admin.image/华为/2017-5-20/笔记本电脑-水杯-桌子-手机.jpg\",\n" +
              "    \"imageUrl5\": \"https://obs.myhwclouds.com/look.admin.image/华为/2017-5-20/笔记本电脑-计算机-树木-草坪.jpg\",\n" +
              "    \"imageUrl6\": \"https://obs.myhwclouds.com/look.admin.image/华为/2017-5-20/键盘-鼠标-桌子.jpg\",\n" +
              "    \"label1\": \"桌子-电脑\",\n" +
              "    \"label2\": \"电脑-鼠标垫-手机\",\n" +
              "    \"label3\": \"眼睛-椅子-桌子\",\n" +
              "    \"label4\": \"水杯-人-电脑\",\n" +
    ...
    public static void main(String[] args) {
        String l="https://obs.myhwclouds.com/look.admin.image/老马识图/2017-05-30-22/atm1.jpg";
        String[] q=l.split("/");
        ...
        @Test
    public  void hhh() {
        judgetable ju=judgelabelservice.getJudgeTableInfoByImageId(40);
            System.out.println(ju==null);
    }
    }
