...
<div class="app-body">
    ...
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">初始化库</li>
        </ol>
            ...
            <div class="animated fadeIn"><%--lhy--%>
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-3" onclick="javascript:location.href='initialize.jsp'">
                        <div class="card card-inverse card-info" style="box-shadow:0px 0px 10px 0px #000">
                            <div class="card-block pb-0" >
